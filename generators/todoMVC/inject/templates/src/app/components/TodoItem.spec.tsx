function todoItemSetup(editing: boolean = false) {
  const props = {
    todo: {
      id: 0,
      text: 'Use Redux',
...
describe('components', () => {
  describe('TodoItem', () => {
    ...
    it('input onChange should call completeTodo', () => {
      const {output, props} = todoItemSetup();
    ...
    it('label onDoubleClick should put component in edit state', () => {
      const {output, renderer} = todoItemSetup();
      const label = output.props.children.props.children[1];
      label.props.onDoubleClick({});
    ...
    it('edit state render', () => {
      const {output} = todoItemSetup(true);
    ...
    it('TodoTextInput onSave should call editTodo', () => {
      const {output, props} = todoItemSetup(true);
    ...
    it('TodoTextInput onSave should exit component from edit state', () => {
      const {output, renderer} = todoItemSetup(true);
      output.props.children.props.onSave('Use Redux');
      const updated = renderer.getRenderOutput();
      expect(updated.type).toBe('li');
